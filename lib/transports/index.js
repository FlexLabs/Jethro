...
Transport.prototype.resetTimestampFormat = function(data) {
...
Transport.prototype.enableDate = function() {
    this._settings.timestamp.date = true;
    return this;
};

Transport.prototype.disableDate = function() {
    this._settings.timestamp.date = false;
    return this;
};
