    ...
    if (typeof settings === "object" && settings !== null) {
        ...
        if (typeof settings.output !== "undefined") {
            ...
            this.colour = {
                ...
                "force": (settings.force && typeof settings.colour.force === 'boolean' ? settings.colour.force : false)
            };
            this.severity = {
            ...
            this.source = {
                "enabled": (settings.source && ['blacklist', 'whitelist'].indexOf(settings.source) > -1 ? settings.source.enabled : null),
            ...
            this.timestamp = {
                ...
                "brackets": (settings.timestamp && typeof settings.timestamp.brackes === 'boolean' ? settings.timestamp.brackets : false)
            };
            this.location = {
                "enabled": (settings.location && typeof settings.location.enable === 'boolean' ? settings.location.enabled : false)
            };
        }
    } else {
