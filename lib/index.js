 ...
 * @type {HttpServer}
 */
var HttpServer = require('./plugins/defaults/http.js');

/**
 * @private
 * @type {Express}
 */
var Express = require('./plugins/native/express.js');
 ...
 * @param {?Date|string} [timestamp] - The timestamp of the message, if not provided, new Date();
 * @param {?string} [namespace] - The namespace for the log to emit to and be handled by
 * @param {?description} description - The description of the error
 * @returns {Jethro} Self
 */
Jethro.prototype.fatal = function(source, message, timestamp, namespace, description, severity) {
    return this._errorHandler(
        this.createError(new Error(), null, {
