...
Jethro.prototype.setTimestampFormat = function(t, data) {
    ...
    if (!(transport instanceof Transport)){
        ...
        transport.setTimestampFormat(data);
    } return this;
};
...
Jethro.prototype.resetTimestampFormat = function(t) {
    ...
    if (!(transport instanceof Transport)){
        ...
        for (var i in transport){
            if (transport.hasOwnProperty(i)){
                arr[i] = transport[i].resetTimestampFormat();
            }
        }
    } else {
        transport.resetTimestampFormat();
    } return this;
};
...
Jethro.prototype.enableDate = function() {
    var transport = this.getTransport(t);
    if (!(transport instanceof Transport)){
        for (var i in transport){
            if (transport.hasOwnProperty(i)){
                transport[i].enableDate();
            }
        }
    } else {
        transport.enableDate();
    } return this;
};

Jethro.prototype.disableDate = function() {
    var transport = this.getTransport(t);
    if (!(transport instanceof Transport)){
        for (var i in transport){
            if (transport.hasOwnProperty(i)){
                transport[i].disableDate();
            }
        }
    } else {
        transport.disableDate();
    } return this;
};
...
module.exports.enableDate = logger.enableDate.bind(logger);
module.exports.disableDate =  logger.disableDate.bind(logger);
