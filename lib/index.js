...
Jethro.prototype.addTransport = function(name, transport) {
    if (transport instanceof Transport) {
        ...
        this.transports[name].onError(this._errorHandler);
        return this;
    } else {
...
Jethro.prototype.clearBlacklist = function(transport) {
    return this._setter(transport, "clearBlacklist");
};
...
Jethro.prototype.addPlugin = function(object, name) {
    ...
    this.plugins[name].onError(this._errorHandler);
    return this;
};
...
Jethro.prototype.importSettings =logger.importSettings.bind(logger);
Jethro.prototype.isValid = logger.isValid.bind(logger);
Jethro.prototype.clean = logger.clean.bind(logger);
