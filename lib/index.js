...
// Classes
var Settings = require('./transports/settings.js');
var Transport = require('./transports/index.js');
var Console = require('./transports/native/console.js');
var File = require('./transports/native/file.js');
...
Jethro.prototype.addTransport = function(name, transport) {
    if (transport instanceof Transport) {
        ...
        this.transports[name]._onError(this._errorHandler);
        return this;
    } else {
...
Jethro.prototype.set = function(transport, settings) {
    console.error("logger.set is deprecated, please use .importSettings instead!");
    return this._setter(transport, "importSettings", settings);
};
...
Jethro.prototype.addPlugin = function(object, name) {
    ...
    this.plugins[name]._onOutput(this._outputHandler);
    this.plugins[name]._onError(this._errorHandler);
    return this;
};
...
module.exports.transports = logger.transports.bind(logger);
module.exports.plugins = logger.plugins.bind(logger);
module.exports.location = logger.location.bind(logger);
module.exports.id = logger.id.bind(logger);
