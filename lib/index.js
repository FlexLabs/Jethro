...
Jethro.prototype.addTransport = function(transport, name) {
    ...
    for (var i in this.namespaces) {
        if (this.namespaces.hasOwnProperty(i)) {
            this.on(this.namespaces[i], this.transports[name].input.bind(transport));
        }
    } return this;
};
 ...
 * @returns {Jethro} - Returning self for chaining purposes
 */
Jethro.prototype.disableColour = function(transport) {
 ...
 * @returns {Jethro} - Returning self for chaining purposes
 */
Jethro.prototype.enableColour = function(transport) {
 ...
 */
Jethro.prototype.getColourSettings = function(transport) {
 ...
 * @returns {Jethro} - Returning self for chaining purposes
 */
Jethro.prototype.disableForceColour = function(transport) {
 ...
 * @returns {Jethro} - Returning self for chaining purposes
 */
Jethro.prototype.enableForceColour = function(transport) {
 ...
 * @returns {Jethro} - Returning self for chaining purposes
 */
Jethro.prototype.disableBoldColour = function(transport) {
 ...
 * @returns {Jethro} - Returning self for chaining purposes
 */
Jethro.prototype.enableBoldColour = function(transport) {
 ...
 * @param {string} [timestamp] - The timestamp of the message, if not provided, new Date();
 */
Jethro.prototype.log = function(severity, source, message, timestamp) {
 ...
 * @returns {Jethro} - Returning self for chaining purposes
 */
Jethro.prototype.warn = Jethro.prototype.warning = function(source, message, timestamp) {
