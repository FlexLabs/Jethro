...
var restify = function(req, res, app){
    ...
    var IP = req.headers['cf-connecting-ip'] || req.headers['x-forwarded-for'] || req.headers['X-Real-IP'] || req.connection.remoteAddress;
    if (IP.substr(0, 3) == "::1"){
        IP = "127.0.0.1";
    ...
    if (n === 400){
        ...
        //This is adhering to best practices standardised by Restify. Reponce version SHOULD be stated as being 'x-api-version'
